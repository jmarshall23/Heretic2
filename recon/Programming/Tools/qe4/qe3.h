...
#define _WIN32_WINNT 0x0800 //for mousewheel code
...
//	int			 d_select_count;
	...
	float		d_maxViewDist;		// Maximum distance at which brushes will be drawn.

	UINT		uMSH_MOUSEWHEEL;   // Value returned from
							      // RegisterWindowMessage()
									// for mousewheel message--
									// win95 & older nt
...
// Reset check box for texture lock
