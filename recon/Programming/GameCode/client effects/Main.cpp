...
// jmarshall - Legacy Client Prediction
			...
			// First, update the current state to the new frame
			cent->current.frame = ent->frame;

			// Then, back-propagate the frames
			cent->prev.olderframe = cent->prev.frame;
			cent->prev.frame = ent->oldframe;
			ent->oldframe = ent->frame;
			ent->olderframe = cent->prev.olderframe;
// jmarshall end
