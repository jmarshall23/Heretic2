...
static qboolean FXDustThink(client_entity_t *dust, centity_t *owner)
{
	...
	ce = FXDebris_Throw(holdorigin, MAT_STONE, dir, 20000.0, flrand(0.75, 2.4), 0, false); // jmarshall: Original code was missing the last param, I'm assuming it should be false
