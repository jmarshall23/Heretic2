...
edict_t	*SV_TestEntityPosition (edict_t *ent)
{
	...
	gi.trace (ent->s.origin, ent->mins, ent->maxs, ent->s.origin, ent, MASK_SOLID,&trace);
...
/*
============
SV_FlyMove (only called by Physics_Step)
...
void SV_Physics_Script_Angular(edict_t *ent)
{
	vec3_t Forward;
